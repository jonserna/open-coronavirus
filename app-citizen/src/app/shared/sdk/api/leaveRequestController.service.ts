...
import { LeaveRequestFilter } from '../model/leaveRequestFilter';
...
export class LeaveRequestControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public leaveRequestControllerFind(filter?: LeaveRequestFilter, observe?: 'body', reportProgress?: boolean): Observable<Array<LeaveRequestWithRelations>>;
    public leaveRequestControllerFind(filter?: LeaveRequestFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<LeaveRequestWithRelations>>>;
    public leaveRequestControllerFind(filter?: LeaveRequestFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<LeaveRequestWithRelations>>>;
    public leaveRequestControllerFind(filter?: LeaveRequestFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public leaveRequestControllerFindById(id: string, filter?: LeaveRequestFilter, observe?: 'body', reportProgress?: boolean): Observable<LeaveRequestWithRelations>;
    public leaveRequestControllerFindById(id: string, filter?: LeaveRequestFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<LeaveRequestWithRelations>>;
    public leaveRequestControllerFindById(id: string, filter?: LeaveRequestFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<LeaveRequestWithRelations>>;
    public leaveRequestControllerFindById(id: string, filter?: LeaveRequestFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
