...
import { TestAppointmentFilter } from '../model/testAppointmentFilter';
...
export class TestAppointmentControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testAppointmentControllerFind(filter?: TestAppointmentFilter, observe?: 'body', reportProgress?: boolean): Observable<Array<TestAppointmentWithRelations>>;
    public testAppointmentControllerFind(filter?: TestAppointmentFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TestAppointmentWithRelations>>>;
    public testAppointmentControllerFind(filter?: TestAppointmentFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TestAppointmentWithRelations>>>;
    public testAppointmentControllerFind(filter?: TestAppointmentFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testAppointmentControllerFindById(id: string, filter?: TestAppointmentFilter, observe?: 'body', reportProgress?: boolean): Observable<TestAppointmentWithRelations>;
    public testAppointmentControllerFindById(id: string, filter?: TestAppointmentFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TestAppointmentWithRelations>>;
    public testAppointmentControllerFindById(id: string, filter?: TestAppointmentFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TestAppointmentWithRelations>>;
    public testAppointmentControllerFindById(id: string, filter?: TestAppointmentFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
