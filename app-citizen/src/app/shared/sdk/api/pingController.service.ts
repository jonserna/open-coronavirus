...
export class PingControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pingControllerPush(deviceId?: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public pingControllerPush(deviceId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public pingControllerPush(deviceId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public pingControllerPush(deviceId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
