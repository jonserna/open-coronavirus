...
export class PatientControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patientControllerFind(filter?: PatientFilter, observe?: 'body', reportProgress?: boolean): Observable<Array<PatientWithRelations>>;
    public patientControllerFind(filter?: PatientFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<PatientWithRelations>>>;
    public patientControllerFind(filter?: PatientFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<PatientWithRelations>>>;
    public patientControllerFind(filter?: PatientFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patientControllerFindById(id: string, filter?: PatientFilter, observe?: 'body', reportProgress?: boolean): Observable<PatientWithRelations>;
    public patientControllerFindById(id: string, filter?: PatientFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PatientWithRelations>>;
    public patientControllerFindById(id: string, filter?: PatientFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PatientWithRelations>>;
    public patientControllerFindById(id: string, filter?: PatientFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patientControllerUpdateStatusByDocumentNumber(apikey?: string, inlineObject?: InlineObject, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public patientControllerUpdateStatusByDocumentNumber(apikey?: string, inlineObject?: InlineObject, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public patientControllerUpdateStatusByDocumentNumber(apikey?: string, inlineObject?: InlineObject, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public patientControllerUpdateStatusByDocumentNumber(apikey?: string, inlineObject?: InlineObject, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
