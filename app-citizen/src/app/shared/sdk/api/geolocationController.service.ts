...
import { GeolocationFilter } from '../model/geolocationFilter';
...
export class GeolocationControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public geolocationControllerFind(filter?: GeolocationFilter, observe?: 'body', reportProgress?: boolean): Observable<Array<GeolocationWithRelations>>;
    public geolocationControllerFind(filter?: GeolocationFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<GeolocationWithRelations>>>;
    public geolocationControllerFind(filter?: GeolocationFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<GeolocationWithRelations>>>;
    public geolocationControllerFind(filter?: GeolocationFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public geolocationControllerFindById(id: string, filter?: GeolocationFilter, observe?: 'body', reportProgress?: boolean): Observable<GeolocationWithRelations>;
    public geolocationControllerFindById(id: string, filter?: GeolocationFilter, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GeolocationWithRelations>>;
    public geolocationControllerFindById(id: string, filter?: GeolocationFilter, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GeolocationWithRelations>>;
    public geolocationControllerFindById(id: string, filter?: GeolocationFilter, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
